...
const ForecastCard = memo(function ForecastCard({ forecast }) {
  ...
  return (
    <Card className="h-full">
      ...
      <CardContent>
        {!hasForecast ? (
          <div className="flex h-48 items-center justify-center rounded-xl border border-dashed border-slate-200 dark:border-slate-800 p-4 text-center text-sm text-slate-500">
            Forecast will be available after sufficient sales data.
          </div>
        ) : (
          <>
